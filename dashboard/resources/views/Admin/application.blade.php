                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        @endif
                         ...
                         <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{route('admin.addproject')}}" aria-expanded="false">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <td align="center" class="txt-oflo">
                                            <a href="{{route('admin.edit',[$value['id']])}}">Edit</a></td> 
                                            </td>
                                        </tr>
                                          @endforeach
