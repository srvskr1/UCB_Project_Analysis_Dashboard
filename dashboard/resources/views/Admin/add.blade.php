                ...
                <!-- ============================================================== -->
                  <div class="table-responsive">
                                        ...
                                        <label for="">Project ID</label><br>
                                            <input type="text" class="form-control" name="project_id" value="{{$new}}" readonly><br>
                                            <label for="">Team</label><br>
                                            <input type="text" name="team" class="form-control" value="{{$team}}" readonly><br>
                                            <label for="">Duration</label><br>
                                            
                                            <input type="number" class="form-control" name="duration"><br>
                                            <label for="">Start Date</label><br>
                                            <input type="date" class="form-control datepicker" id="date-picker-example" name="start"><br>
                                            <label for="">Finish Date</label><br>
                                            <input type="date" class="form-control datepicker"  name="finish"><br>
                                            <label for="">predecessors</label><br>
                                            <input type="text" class="form-control" name="predecessors"><br>
                                            <label for="">Resource Name</label><br>
                                            
                                            <select name="rname" class="form-control" id="">
                                            @foreach($new1 as $value)
                                                <option value="{{$value['name']}}">{{$value['name']}}</option>
                                            @endforeach
                                            </select><br>
                                            <label for="">Complelte(%)</label><br>
                                            <input type="number" class="form-control" name="complete"><br>
                                            <label for="">Remarks</label><br>
                                            <input type="text" class="form-control" name="remarks"><br><br>
